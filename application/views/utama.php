...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url();?>assetku/img/Picture1.ico" type="image/x-icon" />
    <!-- Bootstrap Core CSS -->
		...
		<div class="col-md-8">
			<div class="navbar-header">
					...
					if($role == 'Administrator') 
						...
						<img src="<?php echo base_url(); ?>assetku/img/Untitled-1-removebg-preview.png" style="float:left; height:fixed; width:30%; margin-top:2px; margin-bottom:2px;"> 
					</a>
					</div>
